...
import GridCrossPlaneFrag from "../shaders/GridCrossPlane.frag"
import GridCrossPlaneVert from "../shaders/GridCrossPlane.vert"
...
class GridCrossPlane extends THREE.Group {
    ...
    constructor() {
        ...
        this.mesh = new THREE.Mesh(
            ...
            new THREE.ShaderMaterial({
                vertexShader: GridCrossPlaneVert,
                fragmentShader: GridCrossPlaneFrag,
                uniforms: {
                    time: { value: 0 },
                    // texture1: { value: tex },
